...
async function startATM (){
    ...
    let inpUserName: ({inpUser: string}) = await inquirer.prompt([
        {
            name: "inpUser",
            type: "string",
    ...
    let inpUserPass: ({inpUserPass: number}) = await inquirer.prompt([
        {
            name: "inpUserPass",
            type: "password",
...
const restartFunc = async () => {
    let restartVar: ({inp: string}) = await inquirer.prompt([
        {
            name: "inp",
            id: "string",
...
const transactionFunc = async (amount:number) => {
...
const validataionCheck = async (answer: any) => {
    if (!answer) { 
